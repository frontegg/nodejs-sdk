...
export class TenantsClient {
    ...
    public async getTenant(params: { tenantId: string, filter?: string, sortBy?: string, sortDirection?: string, offset: number, count: number, filters: any }) {
    ...
    // tslint:disable-next-line:max-line-length
    public async deleteTenant(params: { tenantId: string, filter?: string, sortBy?: string, sortDirection?: string, offset: number, count: number, filters: any }) {
    ...
    // tslint:disable-next-line:max-line-length
    public async getTenantEvent(params: { tenantId: string, filter?: string, sortBy?: string, sortDirection?: string, offset: number, count: number, filters: any }) {
    ...
    // tslint:disable-next-line:max-line-length
    public async getTenantKeyHistory(params: { tenantId: string, key: string, filter?: string, sortBy?: string, sortDirection?: string, offset: number, count: number, filters: any }) {
